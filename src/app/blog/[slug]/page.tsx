  ...
  const jsonLd = [
    {
      ...
      // Article rich results strongly favour an image; this is the per-post
      // OG card generated by ./opengraph-image.tsx.
      image: [`${SITE_URL}/blog/${post.slug}/opengraph-image`],
      datePublished: post.dateISO,
      dateModified: post.dateISO,
      inLanguage: "en-AU",
      isAccessibleForFree: true,
      wordCount: getPostBody(post.slug)?.replace(/<[^>]*>/g, " ").split(/\s+/).filter(Boolean).length,
